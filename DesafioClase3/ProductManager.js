...
class ProductManager {
  ...
  addProduct(product) {
    ...
    // Agregamos el id al producto que no cambia nunca y lo agregamos al array y se lo pasamos al metodo save y se guarda en el archivo y se retorna el producto siempre con el id
